...
|---|---|---|
| [cascade](cascade/) | MIDI-out chord strumming instrument. Hold a grid cell and the chord under it strums; hold several and they merge into one strum. Arc edits timing, dynamics and pattern while it rings. | [Manual](cascade/MANUAL.md) · [Notes](cascade/NOTES.md) |
